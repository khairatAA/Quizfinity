...
const ResultsUI = ({
    route, OnPressBack, score, correctAnswers,
    wrongAnswers, timeUsed, totalQuestions
}: ResultsUITypes) => {

    const percentage = (correctAnswers ? Math.floor((correctAnswers / totalQuestions) * 100) : 0) + '%'
            ...
            <View style={styles.detailsContainer}>
                <View style={styles.ResultDetails}>
                    <View>
                        ...
                        />
                        <ResultDetail
                        value={correctAnswers && correctAnswers <= 9 ? '0' + correctAnswers : correctAnswers}
                        title='Correct'
                    ...
                    <View>
                        <ResultDetail
                        value={
                            timeUsed && timeUsed < 60 ? formatTime(timeUsed) + ' secs' : formatTime(timeUsed) + ' mins'
                        }
                        title='Time Used'
                        bulletStyle={styles.CompletedbulletStyle}
                        />
                        <ResultDetail
                        value={wrongAnswers && wrongAnswers <= 9 ? '0' + wrongAnswers : wrongAnswers}
                        title='Wrong'
